...
class Model(pl.LightningModule):
    def __init__(
        ...
        frequency_learning_rate_factor: float,
        ...
        self.frequency_learning_rate_factor = frequency_learning_rate_factor
        ...
        self.proposal_network: ProposalNetwork = th.compile(
            ProposalNetwork(
                frequency_init_min=frequency_init_min,
                frequency_init_max=frequency_init_max,
            )
        )
    ...
    def configure_optimizers(self):
        ...
        self._proposal_optimizer = th.optim.Adam(
            [
                ...
                {
                    "params": self.proposal_network.parameters_activation(), 
                    "lr": self.frequency_learning_rate_factor * self.proposal_learning_rate_start,
                    "initial_lr": self.frequency_learning_rate_factor * self.proposal_learning_rate_start,
                    "weight_decay": self.proposal_weight_decay,
                },
            ]
        )
        ...
        self._radiance_optimizer = th.optim.Adam(
            [
                ...
                {
                    "params": self.radiance_network.parameters_activation(), 
                    "lr": self.frequency_learning_rate_factor * self.radiance_learning_rate_start,
                    "initial_lr": self.frequency_learning_rate_factor * self.radiance_learning_rate_start,
                    "weight_decay": self.radiance_weight_decay,
                },
            ]
        )
